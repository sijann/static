  class MostViewedProducts extends HTMLElement {
    ...
    async getProductsData() {
      try {
        const response = await fetch(`/apps/views-count-dev/mostviewedproducts?store=${this.storeId}`, {
          method: 'GET',
          headers: {
    ...
    createSlider() {
      ...
      const slidesPerPage = typeof slides_per_page !== 'undefined' ? slides_per_page : 4;
      let currentSlide = 0;
